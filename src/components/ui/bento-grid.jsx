      ...
      <Button variant="ghost" asChild size="sm" className="pointer-events-auto">
        <a 
          ...
          onClick={(e) => {
            if (onClick) {
              e.preventDefault();
              e.stopPropagation(); // Prevent event bubbling to parent div to avoid double-firing onClick
              // Call onClick here since stopPropagation prevents it from reaching parent div
              // This ensures onClick fires exactly once when clicking the button
              onClick(e);
            }
            // If no onClick handler, let the link work normally (no preventDefault)
          }}
        >
          {cta}
